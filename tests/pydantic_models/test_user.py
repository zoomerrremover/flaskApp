...
base_user_admin_get_data.update(valid_email_data)
...
def test_user_username_model_invalid_format():
    invalid_data = valid_username_data.copy()
...
def test_user_role_model_invalid_value():
    invalid_data = valid_role_data.copy()
...
def test_user_password_model_invalid_format():
    invalid_data = valid_password_data.copy()
...
def test_user_get_model_invalid_id():
...
def test_user_get_model_missing_required_field():
    invalid_data = base_user_get_data.copy()
...
def test_user_admin_get_model_valid():
...
def test_user_admin_get_model_invalid_email():
...
def test_user_login_model_invalid_username():
...
def test_user_login_model_invalid_password():
    invalid_data = base_user_login_data.copy()
...
def test_user_role_update_model_valid():
...
def test_user_role_update_model_invalid_id():
...
def test_user_role_update_model_invalid_role():
    invalid_data = base_user_role_update_data.copy()
...
def test_user_update_model_invalid_username():
...
def test_user_update_model_invalid_password():
    invalid_data = base_user_update_data.copy()
...
def test_user_update_model_invalid_email():
    invalid_data = base_user_update_data.copy()
