...
def test_article_create_model_valid_data(base_article_create_data):
    """
...
def test_article_create_model_title_too_long(base_article_create_data):
    """
...
def test_article_create_model_text_content_too_long(base_article_create_data):
    """
...
def test_article_create_model_invalid_title_content(base_article_create_data):
    """
...
def test_article_create_model_invalid_text_content(base_article_create_data):
    """
    ...
    with pytest.raises(InvalidDataError) as exc_info:
        ArticleCreateModel(**invalid_data)
    assert ErrorsMsgEnum.ERROR_TEXT_CONTENT in str(exc_info.value)
def test_article_get_model_valid_data(base_article_get_data):
    """
    Tests that ArticleGetModel can be successfully instantiated with valid data,
...
def test_article_get_model_invalid_id(base_article_get_data):
    """
...
def test_article_update_model_valid_data(base_article_update_data):
    """
    Tests that ArticleUpdateModel can be successfully instantiated with valid data,
...
def test_article_update_model_invalid_id(base_article_update_data):
    """
