...
base_course_get_data = base_course_create_data.copy()
base_course_get_data.update(
    {"id": 1, "user_id": 5, "date_posted": datetime.now(timezone.utc)}
)


base_course_update_data = base_course_create_data.copy()
base_course_update_data.update({"id": 2})


def test_course_create_model_valid_data():
...
def test_course_create_model_title_too_long():
...
def test_course_create_model_text_content_too_long():
    invalid_data = base_course_create_data.copy()
...
def test_course_create_model_category_too_long():
    invalid_data = base_course_create_data.copy()
...
def test_course_create_model_invalid_title_content():
    invalid_data = base_course_create_data.copy()
...
def test_course_create_model_invalid_text_content():
    invalid_data = base_course_create_data.copy()
...
def test_course_get_model_valid_data():
...
def test_course_get_model_invalid_id():
...
def test_course_get_model_missing_user_id():
    invalid_data = base_course_get_data.copy()
...
def test_course_update_model_valid_data():
...
def test_course_update_model_invalid_id():
